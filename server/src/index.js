...
app.get("/inicio", (req, res) =>{res.sendFile(path.join(__dirname, "/public/incioo.js"));});
app.get("/contacten", (req,res) =>{res.sendFile(path.join(__dirname, "/public/contacten.js"));});
app.get("/login", (req,res) =>{res.sendFile(path.join(__dirname,  "/public/login.js"))});
