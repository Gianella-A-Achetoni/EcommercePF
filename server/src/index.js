...
app.use(express.static(path.join(process.cwd(), 'client'))); // Sirve archivos estáticos desde el directorio HTML
...
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, 'client', 'HTML', 'incioo.html'));
});
